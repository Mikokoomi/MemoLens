        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemoryDate = table.Column<DateTime>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumMemories", x => new { x.AlbumId, x.MemoryId });
                    table.ForeignKey(
                        name: "FK_AlbumMemories_Albums_AlbumId",
                        column: x => x.AlbumId,
                        principalTable: "Albums",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumMemories_Memories_MemoryId",
                        column: x => x.MemoryId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumMemories_MemoryId",
                table: "AlbumMemories",
                column: "MemoryId");
